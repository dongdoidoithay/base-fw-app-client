                        ...
                        <div className="col-md-7 col-lg-8 col-xl-9">
                            <div className="row">
                                <div className="col-md-12">
                                    <HeaderList current={current}  name={name} totalRecode={totalRecode} setModeView={setModeView}  modeView={modeView} />
                                </div>
                                <div className="col-md-12 mt-2 mb-2">
                                    {isError && <NoDataFound/>}
                                    <ListItem current={current} data={dataList}  modeView={modeView} />
                                </div>
                                <div className="col-md-12">
