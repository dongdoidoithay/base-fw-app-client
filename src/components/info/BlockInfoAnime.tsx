                ...
                <div className="row">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-12 mt-2 mb-2">
                                <div className="novels-detail">
                                    {/*  {isLoadding && <Loadding/>} */}
                                    <iframe style={{ "minHeight": "600px", "minWidth": "100%" }} src={src} allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true} frameBorder={0} marginWidth={0} marginHeight={0} scrolling="no" height="100%" suppressHydrationWarning/>
                    ...
                    <div className="col-12 col-xl-3">
                        <div className="side-bars notranslate">
                            ...
                            <div className="row" style={{ "maxHeight": "620px", "overflowY": "scroll" }}>
